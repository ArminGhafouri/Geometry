...
GeomBase_TSDBuild_Bspline::GeomBase_TSDBuild_Bspline(int deg, std::vector<gp_Pnt> pts)
{
	theDegree_ = deg;
	thePts_ = pts;
...
void  GeomBase_TSDBuild_Bspline::CalcTheU()
{
	theU_ = CalcKnots();
...
void GeomBase_TSDBuild_Bspline::Plot(std::string filename, int n)
{
...
std::vector<int> GeomBase_TSDBuild_Bspline::CalcMutiplicities() const
{
...
std::vector<double> GeomBase_TSDBuild_Bspline::CalcKnots() const
{
...
Handle(Geom_Curve) GeomBase_TSDBuild_Bspline::CreateOCCurve() const
{
